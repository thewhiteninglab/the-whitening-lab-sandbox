    ...
    handlers: {
      GET: async () => {
        ...
        const entries = [
          ...
          { path: "/partnership-opportunities", changefreq: "monthly", priority: "0.6" },
          { path: "/wholesale", changefreq: "monthly", priority: "0.6" },
          { path: "/live-training-courses", changefreq: "monthly", priority: "0.6" },
          { path: "/new-form", changefreq: "monthly", priority: "0.4" },
